                            ...
                            <div class="features row">
                                <div class="col-md-4">
                                    <div class="description">
                                        <img src={{ url('frontend/images/') }}"" alt="" class="features-image">
                                    <div class="description">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-details card-right">
                            ...
                            <div class="members my-2">
                                <img src="{{ url('frontend/images/testi.jpg') }}" class="member-image mr-1 rounded-circle">
                                <img src="{{ url('frontend/images/testi.jpg') }}" class="member-image mr-1 rounded-circle">
                                <img src="{{ url('frontend/images/testi.jpg') }}" class="member-image mr-1 rounded-circle">
                                <img src="{{ url('frontend/images/testi.jpg') }}" class="member-image mr-1 rounded-circle">
                                <img src="{{ url('frontend/images/testi.jpg') }}" class="member-image mr-1 rounded-circle">
                            ...
                            <table class="trip-informations">
                                ...
                                <tr>
                                    ...
                                    <td width="50%" class="text-right">Rp {{ number_format($item->price) }},00 / Person</td>
                                </tr>
                            </table>
                        </div>
